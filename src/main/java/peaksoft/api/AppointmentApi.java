...
public class AppointmentApi {
    ...
    @Autowired
    public AppointmentApi(AppointmentService appointmentService, DepartmentService departmentService, DoctorService doctorService, PatientService patientService) {
    ...
    public String save(@PathVariable Long hospitalId, @ModelAttribute("newAppointment") Appointment appointment) throws MyException {
    ...
    public String edit(Model model,@PathVariable Long hospitalId, @PathVariable Long appointmentId) {
